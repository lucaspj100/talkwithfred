  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">Não foi possível preparar a conversa. Tente novamente.</p>
        <button
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "apple-mobile-web-app-title", content: "Talk With Fred" },
      ...
      { property: "og:title", content: "Talk With Fred — Aprenda inglês conversando" },
      { property: "og:description", content: "Pratique inglês por texto ou voz com Fred, uma IA que conversa com você, corrige seus erros e ajuda você a falar com mais confiança." },
